...
<body>
    ...
    <br>
    <h1 align="center">APPLICATIONS</h1><br>
    ...
    ?>
      <div class="card card-body bg-light" align="center">
    	...
    	<p><b>APPLICATION ID: </b><?php echo $rows['APP_ID'];?></p>
        <p><b>APPLICATION NAME: </b><?php echo $rows['APP_NAME'];?></p>
        <p><b>APPLICATION DESCRIPTION: </b><?php echo $rows['DESCRIPTION'];?></p>
