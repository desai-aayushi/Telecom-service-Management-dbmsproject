...
<?php
  session_start();
  $cid=$_SESSION['cid'];
  $sql="select * from payment where c_id='$cid' ";
...
<body>
    ...
    ?>
            ...
            <p><b>CUSTOMER ID: </b><?php echo $rows['c_id'];?></p>
            <p><b>PAY ID: </b><?php echo $rows['PAY_ID'];?></p>
            <p><b>PAY TYPE: </b><?php echo $rows['PAY_TYPE'];?></p>
            <p><b>AMOUNT: </b><?php echo $rows['AMOUNT'];?></p>
            <p><b>PAY DATE: </b><?php echo $rows['PAY_DATE'];?></p>
