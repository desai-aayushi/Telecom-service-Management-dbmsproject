<?php 
 ...
 $sql="UPDATE `customer` SET `voucher_id`='$voucherid'  WHERE `customer`.`C_ID` = '$cid'";
...
<h3 align="center">VOUCHER APPLIED SUCCESSFULLY!!</h3>
         <h5 align="center">YourPayment Details</h5> 
          <?php
           	$query="Select * From payment WHERE c_id='$cid'";
    ...
    ?>
      ...
      <div class="card card-body bg-light" align="center">
            ...
            <p><b>VOUCHER ID:</b><?php echo $voucherid?></p>
            <p><b>PAYMENT ID: </b><?php echo $rows['PAY_ID'];?></p>
            <p><b>AMOUNT: </b><?php echo $rows['AMOUNT'];?></p>
