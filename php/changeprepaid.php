<?php 
  ...
  $query='Select * From PREPAIDPLANS ';
...
<body>
  <nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
    ...
    <br>
    <h1 align="center">Available Prepaid Plans</h1><br>
      ...
      <div class="card card-body bg-light" align="center">
        <div class="row">
          <div class=col-md-6>
            ...
            <a type="Button" class="btn btn-primary" href='<?php echo"aplly.php?planid=$planid" ?>' id ="apply" type="Submit">APPLY
            </a>
