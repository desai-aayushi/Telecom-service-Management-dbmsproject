...
<?php
  session_start();
  $cid=$_SESSION['cid'];
  $sql="select * from call_history where c_id='$cid' ";
...
<body>
  <nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
    ...
    <h1 align="center">Your Call History</h1>
    <br>
    ...
    ?>
            ...
            <p><b>CALL TYPE: </b><?php echo $rows['CALL_TYPE'];?></p>
            <p><b>CALL START: </b><?php echo $rows['CALL_START'];?></p>
            <p><b>CALL END: </b><?php echo $rows['CALL_END'];?></p>
            <p><b>CALL DATE: </b><?php echo $rows['CALL_DATE'];?></p>
